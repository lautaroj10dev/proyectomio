...
class App {
  ...
  createCamera() {
    const cameraInstance = new Camera(this.gl);
    cameraInstance.fov = 45;
    cameraInstance.position.z = 20;
...
export default function CircularGallery({
  ...
  return (
    <div className="circular-gallery-wrapper">
      ...
      <div className="carousel-labels" ref={labelsRef}>
        {labels.map((item, index) => (
          <div key={index} className="label-item">
            <p className="label-text">{item.text}</p>
          </div>
        ))}
      </div>
    </div>
